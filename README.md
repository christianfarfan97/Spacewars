...
Nave jugador con control mediante teclado.

Enemigos con inteligencia básica y asteroides peligrosos.

Colisiones para disparos y naves

Sistema de sonido para disparos y explosiones.

Menú de inicio.

Barra de vida visible para jugador y enemigos.
